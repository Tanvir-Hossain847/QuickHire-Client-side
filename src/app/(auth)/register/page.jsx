...
export default function Register() {
  ...
  return (
    <div className="min-h-screen bg-white flex">
      {/* Left side: Image/Pattern (Mirrored from Login) */}
      <div className="hidden lg:flex flex-1 relative bg-[#F8F8FD]">
        ...
        <div className="absolute inset-0 bg-gradient-to-t from-[#3d35c8]/80 to-transparent flex flex-col justify-end px-16 pb-24">
           <h2 className="text-white text-4xl font-bold mb-4">Join QuickHire today</h2>
           <p className="text-white/80 text-lg max-w-md">Create an account to save jobs, apply with one click, and get personalized recommendations.</p>
        </div>
      </div>
      ...
      <div className="flex-1 flex flex-col justify-center px-6 sm:px-12 lg:px-24">
        <div className="max-w-md w-full mx-auto">
          ...
          <p className="text-[#515b6f] text-[15px] mb-8">
            Join us to find the best job opportunities.
          </p>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              <label className="block text-sm font-semibold text-[#202941] mb-2" htmlFor="name">
                Full Name
              </label>
          ...
          <p className="mt-10 text-center text-sm text-[#515b6f]">
            ...
            <Link href="/login" className="font-bold text-[#5848DF] hover:text-[#4a3bc6] transition-colors">
              Sign in
            </Link>
          </p>
        </div>
